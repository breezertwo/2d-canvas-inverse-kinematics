...
export class Vec2D {
	 ...
	 */
	public static fromSizeAndAngle(size: number, angle: number): Vec2D {
	 ...
	 */
	public isEqualTo(input: Vec2D): boolean {
	 ...
	 * @param input the other vector
	 */
	public isOppositeTo(input: Vec2D): boolean {
		return this.x == -input.x && this.y == -input.y;
	}
	 ...
	 * @param input the other vector
	 */
	public isParallelTo(input: Vec2D): boolean {
	 ...
	 * @param input the other vector
	 */
	public isAntiParallelTo(input: Vec2D): boolean {
	 ...
	 */
	public add(input: Vec2D): Vec2D {
		return new Vec2D(this.x + input.x, this.y + input.y);
	}
	 ...
	 * the input.
	 */
	public subtract(input: Vec2D): Vec2D {
		return new Vec2D(this.x - input.x, this.y - input.y);
	}
	...
	public normalize(): Vec2D {
		return Vec2D.fromSizeAndAngle(1, this.angle);
	}
	 ...
	 * @param input the other vector
	 */
	public dotProduct(input: Vec2D): number {
	 ...
	 */
	public mirror_Y(): Vec2D {
		return new Vec2D(this.x * -1, this.y);
	}
	 ...
	 * @param input the Vector that must be subtracted to this Vector
	 */
	public distance(input: Vec2D): number {
